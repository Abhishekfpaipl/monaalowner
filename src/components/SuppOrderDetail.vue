    ...
    <div v-if="Object.keys(activeSuppo).length !== 0">
        <div class="offcanvas offcanvas-end show" data-bs-backdrop="static" tabindex="-1" id="staticBackdrop"
            ...
            <div class="offcanvas-body">
                ...
                <button class="mt-2  p-2 bg-light w-100" type="button" data-bs-toggle="collapse" data-bs-target="#payment"
                ...
                <button class="mt-2  p-2 bg-light w-100" type="button" data-bs-toggle="collapse" data-bs-target="#rejection"
                    aria-expanded="false" aria-controls="rejection">
                    <b>Rejection Terms</b>
                </button>
